...
review-level `--resume`, so Qwen attempts native continuation. Resume is
confirmed only by Qwen; incompatible or missing state may fall back to a fresh review.
